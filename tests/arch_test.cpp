...
TEST(arith, x1_to_ieee)
{
    ...
    EXPECT_EQ(x1_to_ieee(0'20'00'00000'00'00'00000ull), 0xf.fffffffffp-2053L); // minreal = 1.547173023691⏨-617
    ...
    EXPECT_EQ(x1_to_ieee(0'57'77'77777'77'77'77777ull), -0xf.fffffffffp-2053L); // -minreal
...
TEST(arith, ieee_to_x1)
{
    ...
    EXPECT_EQ(ieee_to_x1(0xf.fffffffffp-2053L),  0'20'00'00000'00'00'00000ull); // minreal = 1.547173023691⏨-617
    ...
    EXPECT_EQ(ieee_to_x1(-0xf.fffffffffp-2053L), 0'57'77'77777'77'77'77777ull); // -minreal
